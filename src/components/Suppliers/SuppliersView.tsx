...
import { Truck, Star, Plus, X, Edit, Trash2, Package } from 'lucide-react';
import AutomatedRestocking from './AutomatedRestocking';
...
export default function SuppliersView() {
  ...
  const [activeTab, setActiveTab] = useState<'suppliers' | 'restocking'>('suppliers');
